  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item skills">
        ...
        <span class="title2">打上海 major</span>
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">ZZRVTC · 初中在读</span>
          <span class="list-item" style="--color: #eb372a">FE · 无</span>
        </div>
        <img
          class="career-img"
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item">
        ...
        <span class="title1" style="margin-top: 20px">null</span>
        <span class="title2">null</span>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 1fr 1fr">
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">Counter-Strike 2</span>
          <div class="image-desc">
            <span class="left">Counter-Strike 2</span>
          </div>
        </div>
      </div>
      <div
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        ...
        <p class="text">
          创建这个站的时候，想要就是能够有一个自己的<strong>网站</strong>来记叙一些好玩的，让这成为<strong>一段可以回首的记忆</strong>。
        </p>
        <p class="text">
          这个博客权当是做个自我记录吧。当然，如果某篇文章能够帮助到你，那我也是很开心的。
        </p>
        <p class="text">
